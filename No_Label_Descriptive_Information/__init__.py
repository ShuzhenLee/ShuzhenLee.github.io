...
doc = """
No_Label_Descriptive_Information
"""



class C(BaseConstants):
    NAME_IN_URL = 'No_Label_Descriptive_Information'
...
class Stage1(Page):
    def is_displayed(self):
        return self.participant.vars.get('treatment') in ['T3']
...
class Thank_You(Page):
    ...
    def is_displayed(player):
        ...
        return player.participant.vars.get('attention_failed', False) and player.participant.vars.get('treatment') in ['T3']


page_sequence = [Stage1, Part1_Instructions, Table_Graph, Attention2, Thank_You]
