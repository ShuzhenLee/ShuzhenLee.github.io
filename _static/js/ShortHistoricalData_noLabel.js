document.addEventListener('DOMContentLoaded', (function() {
    ...
    function initializeNewChart() {
        ...
        newChart.series[0].setData(conData, false); // Add all Sustainable Fund data
        newChart.series[1].setData(susData, false);
    ...
    function initializeCumulativeChart() {
        cumu_1_Chart = Highcharts.chart('cumu_1_Container', {
            credits: { enabled: false },
            exporting: { enabled: false },
            title: { text: 'Cumulative Return (10 periods)', align: 'left' },
