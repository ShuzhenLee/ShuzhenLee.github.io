document.addEventListener('DOMContentLoaded', (function() {
    ...
    function initializeNewChart() {
        ...
        newChart = Highcharts.chart('newContainer', {
            ...
            series: [
                { name: 'Fund A', data: [], color: '#949494' },
                { name: 'Fund B', data: [], color: ' rgba(59,56,56,0.7)'},
                { name: 'Your Hypothetical Portfolio', data: [], color: '#0000FF' }
            ]
        });
    ...
    function updateUpDownTable(index) {
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: center; font-size: 14px; ">
            <tr style="background-color: #f9f9f9;">
                ...
                <th style="padding: 5px; border: 1px solid #cecbcb; font-weight: bold; width: 120px">Fund A</th>
                <th style="padding: 5px; border: 1px solid #cecbcb; font-weight: bold; width: 120px">Fund B</th>
                <th style="padding: 5px; border: 1px solid #cecbcb; font-weight: bold; width: 120px">Portfolio</th>
            </tr>
    ...
    function initializeCumulativeChart() {
        cumu_1_Chart = Highcharts.chart('cumu_1_Container', {
            ...
            series: [{
                ...
                {
                name: 'Your Hypothetical Portfolio',
    ...
    // document.addEventListener('DOMContentLoaded', function() {
    //     const currentPage = getCurrentPage(); // Assuming getCurrentPage() is defined elsewhere
    //     if (currentPage !== 'P5') {
    //         document.getElementById('revealBtn').addEventListener('click', function (event) {
    //             event.preventDefault();
    //             document.getElementById('summaryTableContainer').style.display = 'block'; // Show the summary table
    //             initializeProjectionsChart();
    //             updateDataLabels(projections);
    //             document.getElementById('projectionContainer').style.display = 'block';
    //             document.getElementById('Next9Periods').style.display = 'block';
    //             document.getElementById('decisionBtn').style.display = 'block';
    //         });
    //         document.getElementById('decisionBtn').addEventListener('click', function(event) {
    //             event.preventDefault();
    //             document.getElementById('decision_slider').style.display = 'block';
