...
doc = """
No_Label_Second_Chance"""

# Constants
class C(BaseConstants):
    NAME_IN_URL = 'No_Label_Second_Chance'
...
class SecondChance(Page):
    ...
    def before_next_page(player, timeout_happened):
        ...
        player.participant.vars['donation_new_chance'] = round(100 + player.second_chance_cumu_sus*player.second_allocation/100, 2)
