...
doc = """
No_Label_FLEX_Real_Investment"""




class C(BaseConstants):
    NAME_IN_URL = 'No_Label_FLEX_Real_Investment'
...
class Stage2(Page):
    def is_displayed(self):
        return self.participant.vars.get('treatment') in ['T3', 'T4']
        ...
        if 'results_sequence' not in self.participant.vars:
            results = [
                ...
                },
                {
                    ...
                    'text': f"The final value if 100 ECUs were fully invested in Fund A: {int(round(100 + self.final_cumu_con))} ECUs."
                },
                {
                    'id': 'sus-investment-result',
                    'text': f"The final value if 100 ECUs were fully invested in Fund B: {int(round(100 + self.final_cumu_sus))} ECUs."
                },
            ]
