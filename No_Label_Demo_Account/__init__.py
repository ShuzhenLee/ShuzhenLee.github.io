...
class C(BaseConstants):
    NAME_IN_URL = 'No_Label_DemoAccount'
...
class Stage1(Page):
    def is_displayed(self):
        return self.participant.vars.get('treatment') in ['T4']
...
class Thank_You(Page):
    ...
    def is_displayed(player):
        ...
        return player.participant.vars.get('attention_failed', False) and player.participant.vars.get('treatment') in ['T4']
